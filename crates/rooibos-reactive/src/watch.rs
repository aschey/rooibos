...
///
/// The return value of `deps` is passed into `callback` as an argument together with the previous
/// value. Additionally the last return value of `callback` is provided as a third argument as is
/// done in [`create_effect`](crate::create_effect).
///
/// ## Usage
///
/// ```
