...
//     border_left, border_right, border_top, border_x, border_y, gap, grow, height,
...
// padding_left, padding_right,     padding_top, padding_x, padding_y, position, show, shrink,
// width, wrap, AlignContent,     AlignItems, AlignSelf, AspectRatio, Basis, Block, Border,
// BorderBottom, BorderLeft,     BorderRight, BorderTop, BorderX, BorderY, Clear, Gap, Grow, Height,
...
// };
// use super::{AsDomNode, DomNode, NodeId};
