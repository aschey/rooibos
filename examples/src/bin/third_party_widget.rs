...
impl_widget!(Tree, visibility=pub, generics=<'a, Identifier:Clone+Eq+Hash+Default+'static>, make_builder=DemoMakeBuilder);
impl_stateful_widget!(Tree, visibility=pub, generics=<'a, Identifier:Clone+Eq+Hash+'static>, state_generics=<Identifier:Clone+Eq+Hash>);
